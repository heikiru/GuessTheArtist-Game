...
public class Menu extends JFrame{
	...
	private Data data;
	// private PlayableMusics playMusic = new PlayableMusic();
	private Game game;
	private int score;
	...
	// private MediaPlayer[] musics = playMusic.getMusics();
	...
	// private Serializer serial = new Serializer();
		...
		public Menu() {
			...
			PanelHistory save = new PanelHistory();
		    ...
		    panel1 = new JPanel(new FlowLayout());
				...
				JButton buttonHistory = new JButton("Saved scores");
							...
							button2.addActionListener(new ActionListener() {
								...
								public void actionPerformed(ActionEvent e) {
									...
									if(isCorrect==true) {
										...
										// musics[musicIndex].setAutoPlay(true);
										// btn_Stop.setOnAction(new EventHandler<ActionEvent>() {
										// 	// Lambda function to define the Stop Button.
